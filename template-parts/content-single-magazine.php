<?php
/**
 * Template part for displaying single post content - Magazine Hero Layout
 *
 * Full-bleed featured image with overlay title for a dramatic editorial feel.
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'single-article single-article-magazine' ); ?>>

    <!-- Full-Bleed Hero with Overlay -->
    <?php if ( has_post_thumbnail() ) : ?>
        <div class="magazine-hero">
            <?php the_post_thumbnail( 'full', array( 'class' => 'magazine-hero-img', 'loading' => 'eager', 'fetchpriority' => 'high' ) ); ?>
    ...
    <?php else : ?>
        <!-- Fallback: no featured image, show standard header -->
        <header class="single-article-header">
            <div class="single-header-top">
                <div class="single-category"><?php custom_theme_category_badge(); ?></div>
                <div class="single-reading-time"><?php custom_theme_reading_time_badge(); ?></div>
            </div>
            <h1 class="single-post-title page-title"><?php the_title(); ?></h1>
            <?php if ( has_excerpt() ) : ?>
                <div class="single-post-subtitle lead"><?php the_excerpt(); ?></div>
            <?php endif; ?>
            <div class="single-post-byline entry-meta">
                <div class="byline-left">
                    <?php custom_theme_posted_by( true ); ?>
    ...
    <!-- Social & Action share bar below hero -->
    <div class="magazine-share-bar">
        <div class="magazine-share-left">
