<?php
/**
 * Template part for displaying single post content - Minimal Clean Layout
 *
 * Clean, distraction-free reading experience. No featured image, centered typography.
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'single-article single-article-minimal' ); ?>>

    <!-- Minimal Header - Clean & Centered -->
    <header class="single-article-header minimal-header">
    ...
    <!-- NO featured image in minimal template -->
